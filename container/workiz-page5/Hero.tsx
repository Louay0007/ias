...
import { workiz5, workizhero5 } from "@/public";
						...
						<div className="w-full flex justify-between sm:gap-[25px] xm:gap-[25px] padding-x sm:flex-col xm:flex-col">
							...
							<div className="w-[50%] sm:w-full xm:w-full sm:flex-col xm:flex-col flex gap-[20px]">
								<div className="w-[50%] sm:w-full xm:w-full flex flex-col gap-y-[40px]">
									...
									IASTAM of IEEE Tunisia Section provides essential resources like onboarding presentations, an internal policy deck and playbook, and a sales deck for software startups.
									</p>
								</div>
									...
									<div className="w-fit rounded-[50px] border border-[#212121] cursor-pointer">
										<Link
											...
											<Rounded
												className="py-[3px]"
												backgroundColor="#000">
												<p className="z-10 px-[15px]">Effective Sales Tools</p>
											</Rounded>
										</Link>
									</div>
								</div>
