...
import { workiz2, workizhero2 } from "@/public";
						...
						<div className="w-full flex justify-between sm:gap-[25px] xm:gap-[25px] padding-x sm:flex-col xm:flex-col">
							...
							<div className="w-[50%] sm:w-full xm:w-full sm:flex-col xm:flex-col flex gap-[20px]">
								<div className="w-[50%] sm:w-full xm:w-full flex flex-col gap-y-[40px]">
									...
									An exhilarating 12-hour hackathon in collaboration with IEEE IAS ISSATSO and IEEE IAS ISTIC SBCS, tackling a cybersecurity challenge
									</p>
								</div>
									...
									<div className="w-fit rounded-[50px] border border-[#212121] cursor-pointer">
										<Link
											...
											<Rounded
												...
												Cybersecurity Challenge Onboarding Guide
												</p>
											</Rounded>
										</Link>
									</div>
									<div className="w-fit rounded-[50px] border border-[#212121] cursor-pointer">
										<Link
											...
											<Rounded
												...
												backgroundColor="#000">
												<p className="z-10 px-[15px]">
												Hackathon Rules & Best Practices Playbook
												</p>
											</Rounded>
										</Link>
									</div>
									<div className="w-fit rounded-[50px] border border-[#212121] cursor-pointer">
										<Link
											...
											<Rounded
												className="py-[3px]"
												backgroundColor="#000">
												<p className="z-10 px-[15px]">Innovative Solutions & Pitch Deck</p>
											</Rounded>
										</Link>
									</div>
								</div>
