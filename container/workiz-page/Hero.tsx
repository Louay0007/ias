						...
						<div className="w-full flex justify-between sm:gap-[25px] xm:gap-[25px] padding-x sm:flex-col xm:flex-col">
							<div className="w-[50%] sm:w-full xm:w-full">
								<h3 className="paragraph font-medium text-secondry font-NeueMontreal">
									About Our Event : <br /><br />
									InnoSpeed 1.0 is an IEEE ISSAT Mateur event by IAS × RAS, driving innovation and technology through hands-on challenges and expert insights. 🚀
								</h3>
							</div>
							<div className="w-[50%] sm:w-full xm:w-full sm:flex-col xm:flex-col flex gap-[20px]">
								<div className="w-[50%] sm:w-full xm:w-full flex flex-col gap-y-[40px]">
									...
									"InnoSpeed 1.0 – Accelerating innovation, &nbsp; &nbsp; &nbsp; igniting the future! 🚀"
									</p>
								</div>
									...
									<div className="w-fit rounded-[50px] border border-[#212121] cursor-pointer">
										<Link
											...
											<Rounded
												className="py-[3px]"
												backgroundColor="#000">
												<p className="z-10 px-[15px]">Accelerate Growth</p>
											</Rounded>
										</Link>
									</div>
								</div>
