					...
					<div className="w-full flex sm:flex-col xm:flex-col justify-between gap-[15px] padding-x">
						...
						<div className="w-1/2 sm:w-full xm:w-full flex justify-between gap-[10px] sm:flex-col xm:flex-col">
							<div>
								...
								The first edition of Innospeed 2.0 was held on Avril 20-21, 2024, exclusively for IEEE ISSATM SB and All IEEE students. Designed to foster innovation and technical growth, the event brought together more than +100 participants in an engaging and dynamic environment.
								</p>
							</div>
