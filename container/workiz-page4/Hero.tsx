...
import { workiz4, workizhero4 } from "@/public";
						...
						<div className="w-full flex justify-between sm:gap-[25px] xm:gap-[25px] padding-x sm:flex-col xm:flex-col">
							...
							<div className="w-[50%] sm:w-full xm:w-full sm:flex-col xm:flex-col flex gap-[20px]">
								<div className="w-[50%] sm:w-full xm:w-full flex flex-col gap-y-[40px]">
									...
									IoT Spark ESPRIT is a dynamic community that fosters innovation, hands-on learning, and collaboration in the field of IoT, connecting students with industry experts and real-world projects.
									</p>
								</div>
									...
									<div className="w-fit rounded-[50px] border border-[#212121] cursor-pointer">
										<Link
											...
											<Rounded
												className="py-[3px]"
												backgroundColor="#000">
												<p className="z-10 px-[15px]">Innovation & Growth</p>
											</Rounded>
										</Link>
									</div>
								</div>
