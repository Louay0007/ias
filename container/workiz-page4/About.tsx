					...
					<div className="w-full flex sm:flex-col xm:flex-col justify-between gap-[15px] padding-x">
						...
						<div className="w-1/2 sm:w-full xm:w-full flex justify-between gap-[10px] sm:flex-col xm:flex-col">
							<div>
								...
								Founded by passionate tech enthusiasts, IoT Spark ESPRIT <br /> is dedicated to fostering innovation in the Internet of Things. <br /> Our mission is to empower students with hands-on experience, industry connections, and the skills to build smart solutions for a connected world.
								</p>
							</div>
							<div className="flex flex-col gap-y-[10px]">
								<div>
									...
									<p className="paragraph font-NeueMontreal text-secondry">
									Internet of Things (IoT), Technology, and Innovation
									</p>
								</div>
								<div>
									<p className="paragraph font-NeueMontreal text-secondry underline">
